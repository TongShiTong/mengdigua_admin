  ...
  <div class="index-tpl">
    <div class="tpl-column">
      ...
      <draggable
        ...
        :style="{backgroundImage: 'url('+ content.bg_img +')',backgroundColor:content.bg_color}"
        class="tpl-column-content">
        <div v-for="(item,index) in content.list" :style="{marginTop:item.top+'px',marginBottom:item.bottom+'px',paddingLeft:item.left+'px',paddingRight:item.right+'px', backgroundColor:item.bgcolor,backgroundImage: 'url('+ item.bgurl +')',backgroundSize:'cover',backgroundRepeat: 'no-repeat', borderRadius:item.borderRadius+'px'}" :key="index" class="tpl-item">
          <div class="tpl-item-box">
            <div v-if="item.type!=2&&item.type!=4&&item.type!=10&&item.type!=11&&item.type!=25&&item.type!=17&&item.type!=19&&item.type!=23&&item.type!=24&&item.type!=20&&item.type!=21&&item.type!=22" class="tpl-item-box1">
              <div v-for="(item1,index1) in item.floor_data" :key="index1" class="item-box-item">
                <img v-if="item1.img_url" :src="item1.img_url">
                <div v-if="!item1.img_url&&item.type!=1&&item.type!=3&&item.type!=6&&item.type!=7&&item.type!=8&&item.type!=9&&item.type!=10&&item.type!=11&&item.type!=12&&item.type!=13&&item.type!=14&&item.type!=15&&item.type!=16&&item.type!=17&&item.type!=19&&item.type!=23&&item.type!=24" class="no-img">
                  未配置
                </div>
            ...
            <el-carousel v-if="item.type==20" trigger="click" height="150px" indicator-position="none">
            ...
            <el-carousel v-if="item.type==2&&item.show_type==0" trigger="click" height="150px" indicator-position="none">
              <el-carousel-item v-for="(item3,index3) in item.floor_data" :key="index3" >
                <!-- <img v-if="item3.img_url" :src="item3.img_url"> -->
                <div v-if="item3.img_url" :style="{backgroundImage: 'url('+ item3.img_url +')'}" style="width:100%;height:100%;background-position: center center;background-size: cover;"/>
                <div v-if="!item3.img_url" class="no-img">
            ...
            <el-carousel v-if="item.type==2&&item.show_type==1" trigger="click" height="150px" indicator-position="none">
              <el-carousel-item v-for="(item3,index3) in item.floor_data" :key="index3">
                <!-- <img v-if="item3.img_url" :src="item3.img_url"> -->
                <div v-if="item3.img_url" :style="{backgroundImage: 'url('+ item3.img_url +')',transform:'scale('+(1-`0.${index3}`)+')'}" style="width:100%;height:100%;background-position: center center;background-size: cover;"/>
                <div v-if="!item3.img_url" class="no-img">
                  未配置2
                </div>
              </el-carousel-item>
            ...
            <el-carousel v-if="item.type==2&&item.show_type==2" trigger="click" height="150px" indicator-position="none">
              <el-carousel-item v-for="(item3,index3) in item.floor_data" :key="index3" >
                <!-- <img v-if="item3.img_url" :src="item3.img_url"> -->
                <div v-if="item3.img_url" :style="{backgroundImage: 'url('+ item3.img_url +')'}" style="width:100%;height:100%;border-top-right-radius: 50px;border-bottom-left-radius: 50px;background-position: center center;background-size: cover;"/>
                <div v-if="!item3.img_url" class="no-img">
                  未配置3
                </div>
              </el-carousel-item>
            ...
            <el-carousel v-if="item.type==2&&item.show_type==3" trigger="click" height="150px" indicator-position="none">
              <el-carousel-item v-for="(item3,index3) in item.floor_data" :key="index3" >
                <!-- <img v-if="item3.img_url" :src="item3.img_url"> -->
                <div v-if="item3.img_url" :style="{backgroundImage: 'url('+ item3.img_url +')'}" style="width:50%;margin: 0 auto;height:100%;background-position: center center;background-size: cover;"/>
                <div v-if="!item3.img_url" class="no-img">
                  未配置4
                </div>
              </el-carousel-item>
            ...
            <div v-if="item.type==4&&item.show_type==1" class="tpl-item-box2">
              <div v-for="(item1,index1) in item.floor_data" :key="index1" class="item-box-item">
                <img v-if="item1.img_url" :src="item1.img_url">
            ...
            <div v-if="item.type==4&&item.show_type==0" class="tpl-item-box3">
              <div v-for="(item1,index1) in item.floor_data" :key="index1" class="item-box-item">
                <img v-if="item1.img_url" :src="item1.img_url">
                <div v-if="item1.img_url" class="c-text">{{ item1.title }}</div>
                <div v-if="!item1.img_url&&item.type!=1&&item.type!=3&&item.type!=6&&item.type!=7&&item.type!=8" class="no-img">
            ...
            <div v-if="item.type==11" class="tpl-item-box1">
              <div class="item-box-item">
                <div v-if="item.show_type==1" class="no-img coupon">
                  <span>优惠券</span>
                </div>
                <div class="no-img coupon">
                  <span>优惠券</span>
                </div>
              </div>
            </div>
            <div v-if="item.type==25" class="tpl-item-box1">
              <div class="item-box-item">
                <div class="no-img coupon">
                  <span>图+优惠券</span>
                </div>
            ...
            <div v-if="item.type==10||item.type==17||item.type==19" class="tpl-item-box1">
              <div class="item-box-item">
                <div v-if="item.type==10" class="no-img vae">
                  <span>自定义商品列表</span>
                </div>
                <div v-if="item.type==17" class="no-img vae2">
                  <span>商品横向</span>
                </div>
                <div v-if="item.type==19" class="no-img ty_sp">
                  <span>通用商品列表</span>
                </div>
              </div>
            </div>
            <div v-if="item.type==21" class="tpl-item-box1">
              <div class="item-box-item">
                <div style="display: flex;border: 1px solid #ccc;text-align: center;">
                  <div style="width:80px;border-right:1px solid #ccc;height: 45px;overflow: hidden;" v-for="(item2,index2) in item.moduleList" :key="index2">{{item2.title}}&nbsp;&nbsp;&nbsp;</div>
                </div>
              </div>
            </div>
            <div v-if="item.type==22" class="tpl-item-box1">
              <div class="item-box-item">
                <div class="no-img shop1" v-if="item.show_type==1">
                  <span>店铺列表{{item.show_type}}</span>
                </div>
                <div class="no-img shop2" v-if="item.show_type==2">
                  <span>店铺列表{{item.show_type}}</span>
                </div>
                <div class="no-img shop3" v-if="item.show_type==3">
                  <span>店铺列表{{item.show_type}}</span>
                </div>
              </div>
            </div>
            <div v-if="item.type==5" class="tpl-item-box1">
              <div class="item-box-item">
                <div class="no-img">
                  <span>单(多)图</span>
                </div>
            ...
            <div v-if="item.type==23" class="tpl-item-box1">
              <div class="item-box-item">
                <div class="no-img shop_group">
                  <span>店铺分组</span>
                </div>
              </div>
            </div>
            <div v-if="item.type==24" class="tpl-item-box1">
              <div class="item-box-item">
                <div class="no-img sp_group">
                  <span>商品分组</span>
                </div>
              </div>
            </div>
            ...
            <el-popover
              ...
              <div class="edit-panel">
                ...
                <div class="one-row">
                  ...
                  <span v-if="item.type==20" style="font-weight:600;color: #1f2f3d;">顶部图片配置<span style="color: red;">(图片尺寸推荐：650*300。每张一致。)</span></span>
                  <span v-if="item.type==3" style="font-weight:600;color: #1f2f3d;">公告配置</span>
                  <span v-if="item.type==21" style="font-weight:600;color: #1f2f3d;">分类导航配置</span>
                  <span v-if="item.type==22" style="font-weight:600;color: #1f2f3d;">店铺列表配置</span>
                  ...
                  <span v-if="item.type==18" style="font-weight:600;color: #1f2f3d;">半屏配置<span style="color: red;">(图片，或者活动。)</span></span>
                  ...
                  <span v-if="item.type==17" style="font-weight:600;color: #1f2f3d;">商品横向</span>
                  <span v-if="item.type==19" style="font-weight:600;color: #1f2f3d;">通用商品列表</span>
                  <span v-if="item.type==23" style="font-weight:600;color: #1f2f3d;">店铺分组</span>
                  <span v-if="item.type==24" style="font-weight:600;color: #1f2f3d;">商品分组</span>
                  <span v-if="item.type==11" style="font-weight:600;color: #1f2f3d;">优惠券</span>
                  <span v-if="item.type==25" style="font-weight:600;color: #1f2f3d;">优惠券</span>
                ...
                <div class="one-row">
                  <div class="row-col">
                    ...
                    <div>
                      <el-input-number v-model="item.top" :min="0" :max="100" style="width:110px;" size="mini" label="顶部间隙"/>
                    </div>
                  </div>
                  <div class="row-col">
                    <div class="col-label">
                    ...
                    <div>
                      <el-input-number v-model="item.bottom" :min="0" :max="100" style="width:110px;" size="mini" label="底部间隙"/>
                    </div>
                  </div>
                  <div class="row-col">
                    <div class="col-label">
                ...
                <div class="one-row">
                  <div class="row-col">
                    ...
                    <div>
                      <el-input-number v-model="item.left" :min="0" :max="100" style="width:110px;" size="mini" label="顶部间隙"/>
                    </div>
                  </div>
                  <div class="row-col">
                    <div class="col-label">
                    ...
                    <div>
                      <el-input-number v-model="item.right" :min="0" :max="100" style="width:110px;" size="mini" label="底部间隙"/>
                    </div>
                  </div>
                  <div class="row-col" v-if="item.type==2">
                    <div class="col-label">
                      类型
                    </div>
                    <div>
                      <el-select v-model="item.show_type" style="width:120px;" size="mini" placeholder="请选择">
                        <el-option :key="0" :label="'普通'" :value="0"/>
                        <el-option :key="1" :label="'层叠'" :value="1"/>
                        <el-option :key="2" :label="'圆角'" :value="2"/>
                        <el-option :key="3" :label="'方型'" :value="3"/>
                      </el-select>
                    </div>
                  </div>
                  <div class="row-col" v-else-if="item.type==4">
                    <div class="col-label">
                      类型
                    </div>
                    <div>
                      <el-select v-model="item.show_type" style="width:120px;" size="mini" placeholder="请选择">
                        <el-option :key="0" :label="'单行'" :value="0"/>
                        <el-option :key="1" :label="'多行'" :value="1"/>
                      </el-select>
                    </div>
                  </div>
                  <div class="row-col" v-else-if="item.type==11">
                    <div class="col-label">
                      类型
                    </div>
                    <div>
                  ...
                  <div class="row-col" v-else-if="item.type==20">
                    <div class="col-label">
                      类型
                    </div>
                    <div>
                      <el-select v-model="item.show_type" style="width:120px;" size="mini" placeholder="请选择">
                        <el-option :key="0" :label="'黑色'" :value="0"/>
                        <el-option :key="1" :label="'白色'" :value="1"/>
                      </el-select>
                    </div>
                  </div>
                ...
                <div class="one-row" style="position: relative;">
                  <div class="row-col" style="flex:none">
                    <div class="col-label">
                      圆角值
                    </div>
                    <div>
                      <el-input-number v-model="item.borderRadius" :min="0" :max="100" style="width:110px;" size="mini" label="顶部间隙"/>
                    </div>
                  </div>
                  <div class="row-col" style="flex:none">
                    <div class="col-label">
                  ...
                  <div class="row-col" style="flex:none">
                    ...
                    <div>
                      <el-select v-model="item.shadow" style="width:120px;" size="mini" placeholder="请选择">
                        <el-option :key="0" :label="'无'" :value="0"/>
                        <el-option :key="1" :label="'有'" :value="1"/>
                      </el-select>
                    </div>
                  </div>
                  <div class="row-col" v-if="item.type==3" style="flex:none;position: absolute;top: 40px;">
                    <div class="col-label">
                      显示公告
                    </div>
                    <div>
                      <el-select v-model="item.isShow" style="width:120px;" size="mini" placeholder="请选择">
                  ...
                  <!-- 公告里面设置显示几项 -->
                  <div v-if="item.type==3" class="row-col" style="flex:none;margin-bottom:10px;position: absolute;top: 80px;">
                    <span>选择模块：</span>
                    <el-select v-model="item.listNums" style="width:150px;padding-right:15px;" size="mini" placeholder="请选择配置项" @change="chooseMukuai(index,item.listNums)">
                      <el-option label="模块1" :disabled="true" value="1"/>
                      <el-option label="模块2" value="2"/>
                      <el-option label="模块3" value="3"/>
                      <el-option label="模块4" value="4"/>
                      <el-option label="模块5" value="5"/>
                      <el-option label="模块6" value="6"/>
                      <el-option label="模块7" value="7"/>
                    </el-select><span style="color:red;">(*此处可选配置项)</span>
                  </div>
                </div>
                <!-- <div class="one-row">
                  
                </div> -->
                <div v-if="item.type==6||item.type==7||item.type==8||item.type==9||item.type==10||item.type==17||item.type==19||item.type==23||item.type==12||item.type==13||item.type==14||item.type==15||item.type==16||item.type==24" class="two-row">
                  <el-row style="line-height:32px;display:flex;">
                    <span v-if="item.type!=10&&item.type!=17&&item.type!=19&&item.type!=23&&item.type!=24" style="padding-right:15px;">显示个数</span>
                    <el-select v-if="item.type!=10&&item.type!=17&&item.type!=19&&item.type!=23&&item.type!=24" v-model="item.nums" style="width:110px;padding-right:15px;" size="mini" placeholder="显示个数" @change="setNums(index,item.type)">
                    ...
                    <span style="padding-right:15px;" v-if="item.type!=23&&item.type!=24">模块标题</span>
                    <el-input v-model="item.title" v-if="item.type!=23&&item.type!=24" style="width:200px;" size="mini" placeholder="显示标题"/>
                    <el-button @click="addTab1(index)" type="primary" round size="mini" style="margin-left: 10px;" v-if="item.type==19&&item.moduleList.length<4">添加tab栏</el-button>
                  </el-row>
                </div>

                 <div v-if="item.type==21" style="text-align: center;">
                  <el-button @click="chooseMukuaifl(index)" type="primary" round size="mini" style="margin-left: 10px;" >添加分类</el-button>
                </div>

                <div v-if="item.type==22">
                  <div v-if="item.shop_title!=undefined">
                    <span style="padding-right:15px;">显示标题</span>
                    <el-input v-model="item.shop_title" style="width:200px;" size="mini" placeholder="显示标题"/>
                    <el-button v-if="item.show_type==3" @click="chooseMukuai1(index,3)" type="primary" round size="mini" style="margin-left: 10px;" >添加店铺</el-button>
                  </div>
                </div>

                <div style="max-height: 520px;overflow-y: auto;" class="gdt">

                  <div v-if="item.type!=1&&item.type!=6&&item.type!=7&&item.type!=8&&item.type!=9&&item.type!=10&&item.type!=17&&item.type!=11&&item.type!=12&&item.type!=13&&item.type!=14&&item.type!=15&&item.type!=16&&item.type!=19&&item.type!=21&&item.type!=22&&item.type!=23&&item.type!=24" class="two-row">
                    <div v-for="(item2,index2) in item.floor_data" :key="index2" class="two-row-item">
                      <div class="item-btns" v-if="item.type!=20">
                        <el-row>
                          ...
                          <el-button v-if="item.type!=18" type="danger" icon="el-icon-delete" size="mini" circle @click="delImg(index,index2)"/>
                        </el-row>
                      </div>
                      <div class="item-content">
                        ...
                        <div class="data-box">
                          ...
                          <el-row style="line-height:34px;">
                            <span v-if="item.type!=18||item2.kind==1" style="font-size:12px;">打开页面：</span>
                            <el-select v-if="item.type!=18||item2.kind==1" v-model="item2.type" style="width:160px;" size="mini" placeholder="打开页面" @change="changeItem1(index,index2)">
                              ...
                              <el-option v-if="tplInfo.shop_id==0" label="分佣商品列表" value="16"/>
                              <!-- <el-option v-if="tplInfo.shop_id==0" label="限时购" value="17"/> -->
                            </el-select>
                            <span v-if="item.type!=18||item2.kind==1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <span v-if="item.type==18" style="font-size:12px;">显示类型：</span>
                            <el-select v-if="item.type==18" v-model="item2.kind" style="width:160px;" size="mini" placeholder="选择类型" @change="xianshiC(index,index2,item2.kind)">
                              <el-option label="图片" value="1"/>
                              <el-option label="限时购" value="2"/>
                            </el-select>
                          ...
                          <el-row v-if="item.type!=18||item2.kind==1" style="line-height:32px;display:flex;">
                            ...
                            <span v-if="item2.type==20" style="color:red;">(商品分类id)</span>
                            ...
                            <span v-if="item2.type==18" style="color:red;">(不必填)</span>
                            ...
                            <span v-if="item2.type==17" style="color:red;">(不必填)</span>
                            <span v-if="item2.type==19" style="color:red;">(不必填)</span>
                          ...
                          <el-row v-if="item.type==5||item.type==18" style="line-height:32px;display:flex;">
                      ...
                      <div v-if="item.type==25">
                        <div v-for="(item4,index4) in item2.coupon_list" :key="index4" style="display: flex;border: 1px solid #dddddd;align-items: center;justify-content: space-between;margin: 5px 10px;padding: 0 5px;border-radius: 4px;">
                          <div>
                            <div>优惠券名称：{{item4.name}}</div>
                            <div>优惠券ID：{{item4.id}}</div>
                          </div>
                          <div>
                            <el-button @click="deletaMokuia2(index,index2,index4)" type="warning" size="mini">删除</el-button>
                          </div>
                        </div>
                        
                        <div style="text-align: center;" v-if="item2.coupon_list.length<3">
                          <el-button type="primary" size="mini" round @click="addImg5(index,index2)">添加优惠券</el-button>
                          <span style="color:red;">（*最多选择三张优惠券）</span>
                        </div>
                      </div>
                    </div>

                    <div v-if="item.floor_data.length<30" style="line-height:32px;text-align:center;">
                      <div v-if="item.type!=20">
                        <el-button v-if="item.type!=18||item.floor_data.length<2" type="primary" icon="el-icon-plus" size="mini" circle @click="addImg(index,item.type)"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div v-if="item.type==11">
                    <div v-for="(item3,index3) in item.floor_data" :key="index3" style="border: 1px solid #ccc;border-radius: 4px;padding: 5px;margin-bottom: 10px;display:flex;justify-content: space-between;align-items: center;">
                      <div>
                        <div>优惠券名称：{{item3.name}}</div>
                        <div>优惠券ID：{{item3.id}}</div>
                      </div>
                      <div>
                        <el-button @click="deletaMokuia1(index,index3)" type="warning" size="mini">删除</el-button>
                      </div>
                      
                    </div>
                    <div style="text-align: center;">
                      <el-button type="primary" size="mini" round @click="addImg4(index,item.type)">添加优惠券</el-button>
                    </div>
                  </div>

                  <!-- 分类列表 -->
                  <div v-if="item.type==21">
                    <div v-for="(item2,index2) in item.moduleList" :key="index2" style="padding: 10px;position: relative;">
                      <div style="margin-bottom:10px">
                        <span>分类标题</span>
                        <el-input v-model="item2.title" style="width:200px;" size="mini" placeholder="显示标题"/>
                      </div>
                      <div>
                        <span>分类参数</span>
                        <el-input v-model="item2.param" :disabled="true" style="width:200px;" size="mini" placeholder="显示标题"/>
                        <el-button type="primary" @click="addCory(index,index2)" size="mini" icon="el-icon-search" circle></el-button>
                        <span style="color:red;">（* 选择分类导航栏参数,不选默认推荐商品）</span>
                        <el-button type="danger" icon="el-icon-delete" circle @click="deletaMokuia(index,index2)" size="mini" style="position: absolute;right: 10px;"></el-button>
                      </div>
                    </div>
                  ...
                  <div v-if="item.type==19">
                    ...
                    <div v-for="(item3,index3) in item.moduleList" :key="index3" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      <el-row style="line-height:32px;display:flex;">
                        <span style="padding-right:4px;">模块标题：</span>
                        <el-input v-model="item3.title" style="width:350px;" size="mini" placeholder="模块标题" />
                      </el-row>
                      <el-row style="line-height:32px;display:flex;">
                        <span style="padding-right:4px;">标题简介：</span>
                        <el-input v-model="item3.content" style="width:350px;" size="mini" placeholder="标题简介" />
                      </el-row>

                      <div class="two-row">
                        <div v-for="(item4,index4) in item3.floor_data" :key="index4" class="two-row-item">
                          <div class="item-btns">
                            <el-row>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg1(index,index3,index4)"/>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-up" size="mini" circle @click="upImg1(index,index3,index4)"/>
                              <el-button type="danger" icon="el-icon-delete" size="mini" circle @click="delImg1(index,index3,index4)"/>
                            </el-row>
                          </div>
                          <div class="item-content">
                            <div class="img-box">
                              <div v-if="item4.good_info.img_url" :style="{backgroundImage: 'url('+ item4.good_info.img_url +')'}" class="avatar"/>
                            </div>
                            <div class="data-box">
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;">商品名称：{{ item4.good_info.title }}</span>
                              </el-row>
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;">商品id：{{ item4.good_info.item_id }}</span>
                              </el-row>
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;">商品价格：￥{{ item4.good_info.price }}</span>
                              </el-row>
                              <!-- <el-row style="line-height:32px;display:flex;">
                          ...
                          <div class="data-box">
                              ...
                              <el-row style="line-height:34px;">
                                ...
                                <el-select v-model="item4.type" style="width:160px;" size="mini" placeholder="打开页面">
                                  <el-option label="无" value="0"/>
                                  <el-option label="商品" value="1"/>
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="礼包商品" value="15"/> -->
                                  <el-option label="装修页" value="9"/>
                              ...
                              <el-row v-if="item4.type==1||item4.type==15" style="line-height:34px;">
                                <span style="font-size:12px;">商品名字：{{ item4.good_info.title }}</span>
                              </el-row>
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;font-size:12px;">页面参数：</span>
                                <el-input v-model="item4.param" :disabled="item4.type==1||item4.type==2||item4.type==3" style="width:300px;" size="mini" class="input-with-select">
                                  <el-button slot="append" size="mini" icon="el-icon-search" @click="selectItem2(item4.type,index,index3,index4)"/>
                                </el-input>
                                <span v-if="item4.type==0" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==1" style="color:red;">(商品id)</span>
                                <span v-if="item4.type==2" style="color:red;">(商品分类id)</span>
                                <span v-if="item4.type==20" style="color:red;">(商品分类id)</span>
                                <span v-if="item4.type==3" style="color:red;">(店铺id)</span>
                                <span v-if="item4.type==4" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==5" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==18" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==6" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==7" style="color:red;">(富文本id)</span>
                                <span v-if="item4.type==8" style="color:red;">(外链链接)</span>
                                <span v-if="item4.type==9" style="color:red;">(装修页id)</span>
                                <span v-if="item4.type==10" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==17" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==19" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==11" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==13" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==14" style="color:red;">(不必填)</span>
                                <span v-if="item4.type==15" style="color:red;">(礼包商品id)</span>
                              </el-row>
                              <!-- <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;font-size:12px;">图片标题：</span>
                                <el-input v-model="item4.imgtit" style="width:300px;" size="mini" class="input-with-select" placeholder="(选填)"/>
                              </el-row>
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;font-size:12px;">标题简介：</span>
                                <el-input v-model="item4.content" style="width:300px;" size="mini" class="input-with-select" placeholder="(选填)"/>
                              </el-row> -->
                            </div>
                        ...
                        <div style="line-height:32px;text-align:center;">
                          <el-button type="primary" icon="el-icon-plus" size="mini" circle @click="addImg1(index,index3,item.type)"/>
                        </div>
                      </div>
                      <el-button @click="deletaMokuia(index,index3)" type="warning" size="mini" style="position: absolute;right:10px;bottom:8px;z-index: 11;">删除模块{{index3+1}}</el-button>
                    </div>
                  </div>

                  <!-- 店铺分组第二部分 -->
                  <div v-if="item.type==23 || item.type==24">

                    <div v-for="(item3,index3) in item.moduleList" :key="index3" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      <div style="line-height:32px;display:flex;height:30px">
                        <div style="width:72px">分类标题</div>
                        <el-input v-model="item3.title" :disabled='!item3.isEdit' style="width:150px;margin-right:10px" size="mini" placeholder="设置tab名称" />
                      <!-- </el-row>
                      <el-row style="line-height:32px;display:flex;"> -->
                        <div style="width:56px">排序值</div>
                        <el-input type="number" v-model="item3.sort" :disabled='!item3.isEdit' style="width:150px;margin-right:20px" size="mini" placeholder="升序排序" />
                        <el-button type="primary" size="mini" @click="editGroup(index,index3)" v-if="!item3.isEdit">编辑</el-button>
                        <el-button type="primary" size="mini" @click="saveGroup(index,index3)" v-else>保存</el-button>

                        <el-button @click="deletaMokuia(index,index3)" type="warning" size="mini">删除</el-button>
                      </div>

                      
                        <div style="margin-top:10px" v-if="item.type==23">
                          <span style="margin-right:10px">店铺样式</span>
                          <el-select v-model="item3.style" style="width:150px;" :disabled="!item3.isEdit" size="mini" placeholder="请选择">
                            <el-option :key="0" :label="'方形'" :value="0"/>
                            <el-option :key="1" :label="'矩形'" :value="1"/>
                          </el-select>
                          <span style="margin-left:10px;color:red;">（*是指里面包裹图片的形状）</span>
                        </div>
                     

                      <div style="margin:12px 0 6px 0;">列表商品组成</div>
                      <div style="display:flex;justify-content: space-between;" v-if="item3.isEdit">
                        <div style="width:45%">
                          <div style="font-size:13px;color:#ccc">商品类目</div>
                          <el-tree
                            class="tree"
                            :data="data1"
                            show-checkbox
                            ...
                            node-key="id"
                            :props="defaultProps1"
                            :default-checked-keys = item3.spLeimu
                            @check="handleNodeClick1"
                            style="width: 100%;height: 200px;overflow: auto;padding: 10px;border: 1px solid #ddd;border-radius: 4px;">
                          </el-tree>
                        </div>

                        <div style="width:45%">
                          <div style="font-size:13px;color:#ccc">商品分类</div>
                          <el-tree
                            class="tree"
                            :data="data"
                            show-checkbox
                            ...
                            :default-expand-all='true'
                            :props="defaultProps"
                            :default-checked-keys = item3.spFenlei
                            @check="handleNodeClick"
                            style="width: 100%;height: 200px;overflow: auto;padding: 10px;border: 1px solid #ddd;border-radius: 4px;">
                          </el-tree>
                        </div>
                      </div>
                      <div style="display:flex;justify-content: space-between;color:#bbb;" v-else>
                        <div style="width:45%">
                          <div style="font-size:13px;color:#ccc">商品类目</div>
                          <div class="tree" style="width: 100%;min-height: 100px;max-height: 200px;overflow: auto;padding: 10px;border: 1px solid #ddd;border-radius: 4px;">
                            <span style="margin-right:10px" v-for="(item4,index4) in item3.spLeimuData" :key="index4">{{item4.name}}</span>
                            <span v-if="item3.spLeimuData.length<=0">暂无数据</span>
                          </div>
                        </div>
                        ...
                        <div style="width:45%">
                          <div style="font-size:13px;color:#ccc">商品分类</div>
                          <div class="tree" style="width: 100%;min-height: 100px;max-height: 200px;overflow: auto;padding: 10px;border: 1px solid #ddd;border-radius: 4px;">
                            <span style="margin-right:10px" v-for="(item4,index4) in item3.spFenleiData" :key="index4">{{item4.name}}</span>
                            <span v-if="item3.spFenleiData.length<=0">暂无数据</span>
                          </div>
                        </div>
                        
                      </div>
                      <div v-if="item.type==23">
                        <div v-if="item3.isEdit">
                          <div style="font-size:13px;color:#ccc;margin: 12px 0 6px;">列表店铺</div>
                          <div style="border:1px solid #ddd;height: 30px;padding: 4px;font-size: 14px;border-radius: 4px;" @click="addImg3(index,index3,item.type)">
                            <span v-for="(item4,index4) in item3.floor_data" :key="index4">{{ item4.name }}<span v-if="item3.floor_data.length!=0">，</span></span>
                            <span v-if="item3.floor_data.length<=0" style="color:#cccc">请选择店铺</span>
                          </div>
                        </div>
                        <div v-else>
                          <div style="font-size:13px;color:#ccc;margin: 12px 0 6px;">列表店铺</div>
                          <div style="border:1px solid #ddd;height: 30px;padding: 4px;font-size: 14px;border-radius: 4px;color:#bbb;">
                            <span v-for="(item4,index4) in item3.floor_data" :key="index4">{{ item4.name }}<span v-if="item3.floor_data.length!=0">，</span></span>
                            <span v-if="item3.floor_data.length<=0" style="color:#cccc">暂无选择店铺</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <!-- <div class="two-row">
                        <div v-for="(item4,index4) in item3.floor_data" :key="index4" class="two-row-item" style="min-height:auto">
                          <div class="item-btns" style="top:30px">
                            <el-row>
                              
                              <el-button type="danger" icon="el-icon-delete" size="mini" circle @click="delImg3(index,index3,index4)"/>
                            </el-row>
                          </div>
                          <div class="item-content">
                           
                            <div class="data-box" style="min-height:auto">
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;">店铺名称：{{ item4.name }}</span>
                              </el-row>
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;">店铺id：{{ item4.id }}</span>
                              </el-row>
                        ...
                        <div style="line-height:32px;text-align:center;">
                          <el-button type="primary" icon="el-icon-plus" size="mini" circle @click="addImg3(index,index3,item.type)"/>
                        </div>
                      </div> -->
                      
                    </div>
                    <div style="display: flex;justify-content: center;" v-if="item.type==23">
                      <el-button @click="addTab(index)" type="primary" size="mini" round>添加店铺分组</el-button>
                    </div>
                    <div style="display: flex;justify-content: center;" v-if="item.type==24">
                      <el-button @click="addTab2(index)" type="primary" size="mini" round>添加店铺分组</el-button>
                    </div>
                  </div>
                  ...
                  <div v-if="item.type==22">
                    ...
                    <div v-for="(item3,index3) in item.moduleList" :key="index3+'i'" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      
                      <div class="two-row">
                        <div v-for="(item2,index2) in item3.image_data" :key="index2+'a'" class="two-row-item">
                          <!-- <div class="item-btns">
                            <el-row>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg2(index,index3,index2)"/>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-up" size="mini" circle @click="upImg2(index,index3,index2)"/>
                              <el-button  type="danger" icon="el-icon-delete" size="mini" circle @click="delImg2(index,index3,index2)"/>
                            </el-row>
                          </div> -->
                          <div class="item-content">
                            <div class="img-box" @click="setIndex2(index,index3,index2)">
                              <el-upload
                                :data="{index:index,index3:index3,index2:index2}"
                                :show-file-list="false"
                                :on-success="handleGgSuccess"
                                :before-upload="beforeAvatarUpload"
                                :action="base_api+'/material/index/upload'"
                                class="avatar-uploader">
                                <div v-if="item2.img_url" :style="{backgroundImage: 'url('+ item2.img_url +')'}" class="avatar"/>
                            ...
                            <div class="data-box">
                              ...
                              <el-row style="line-height:34px;">
                                <span style="font-size:12px;">打开页面：</span>
                                <el-select v-model="item2.type" style="width:160px;" size="mini" placeholder="打开页面" @change="changeItem(index,index3,index2)">
                                  <el-option label="无" value="0"/>
                                  <el-option label="商品" value="1"/>
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="礼包商品" value="15"/> -->
                                  <el-option label="装修页" value="9"/>
                                  ...
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="VIP专区" value="12"/> -->
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="签到领币" value="13"/> -->
                                  <!-- <el-option label="富文本" :disabled="true" value="7"/> -->
                                  <el-option label="外链" value="8"/>
                                  <el-option v-if="tplInfo.shop_id==0" label="分类商品列表" value="2"/>
                                  <el-option label="店铺" value="3"/>
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="热门商品列表" value="4"/>
                                  ...
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="分佣商品列表" value="16"/> -->
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="限时购" value="17"/> -->
                                </el-select><span style="color:red;">(此处应选择店铺)</span>
                              ...
                              <el-row style="line-height:32px;display:flex;">
                                <span style="padding-right:4px;font-size:12px;">标题简介：</span>
                                <el-input v-model="item2.content" style="width:300px;" size="mini" class="input-with-select" placeholder="(选填)"/>
                              </el-row> -->
                            </div>
                          </div>
                        </div>
                        ...
                        <!-- <div style="line-height:32px;text-align:center;">
                          <el-button  type="primary" icon="el-icon-plus" size="mini" circle @click="addImg2(index,index3,item.type)"/>
                        </div> -->
                      <!-- </div>
                      ...
                      <div class="two-row"> -->
                        <div v-for="(item4,index4) in item3.floor_data" :key="index4" class="two-row-item">
                          ...
                          <div class="item-content">
                            ...
                            <div class="img-box" @click="setIndex2(index,index3,index4)">
                              <el-upload
                                :data="{index:index,index3:index3,index4:index4}"
                                :show-file-list="false"
                                :on-success="handleGgtpSuccess"
                                :before-upload="beforeAvatarUpload"
                                :action="base_api+'/material/index/upload'"
                                class="avatar-uploader">
                                <div v-if="item4.img_url" :style="{backgroundImage: 'url('+ item4.img_url +')'}" class="avatar"/>
                                <!-- <i v-else class="el-icon-plus avatar-uploader-icon"/> -->
                                <div v-else :style="{backgroundImage: 'url('+ item4.good_info.img_url +')'}" class="avatar"/>
                              </el-upload>
                            </div>
                            <div class="data-box">
                              <el-row style="line-height:32px;display:flex;">
                      ...
                      <el-button v-if="item3.type==3" @click="deletaMokuia(index,index3)" type="warning" size="mini" style="position: absolute;right:10px;bottom:8px;z-index: 11;">删除店铺{{index3+1}}</el-button>
                    </div>
                  </div>
                  ...
                  <div v-if="item.type==3">
                    <div v-for="(item3,index3) in item.moduleList" :key="index3" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      ...
                      <!-- <el-row style="line-height:32px;display:flex;" v-if="item3.title1!==undefined">
                        <span style="padding-right:4px;">模块标题2：</span>
                        <el-input v-model="item3.title1" style="width:350px;" size="mini" placeholder="模块标题" />
                      </el-row>
                      <el-row style="line-height:32px;display:flex;" v-if="item3.content1!==undefined">
                        <span style="padding-right:4px;">标题简介2：</span>
                        <el-input v-model="item3.content1" style="width:350px;" size="mini" placeholder="标题简介" />
                      </el-row> -->

                      <el-row v-if="item3.isprogress" style="line-height:32px;display:flex;">
                        <span>是否显示进度条：</span>
                        <el-select v-model="item3.hasprogress" style="width:110px;padding-right:15px;" size="mini">
                          <el-option :key="0" :disabled="true" :label="'否'" :value="0"/>
                          <el-option :key="1" :label="'是'" :value="1"/>
                        </el-select>
                        <span style="color:red;">(*如果不显示进度请选模块3)</span>
                      </el-row>
                      
                      <div class="two-row" v-if="item3.hasfloor_data">
                        <div v-for="(item4,index4) in item3.floor_data" :key="index4" class="two-row-item">
                          <div class="item-btns">
                            <el-row>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg1(index,index3,index4)"/>
                      ...
                      <!-- <div v-if="item3.hasimage_url" class="row-col" style="display:flex;align-items: center;margin: 10px 0;">
                        <span class="col-label">
                          上传图片：
                        </span>
                        <div class="img-box" @click="setIndex2(index,index3)">
                          <el-upload
                            :data="{index:index,index3:index3}"
                            :show-file-list="false"
                            :on-success="handleGgSuccess"
                            :before-upload="beforeAvatarUpload"
                            :action="base_api+'/material/index/upload'"
                      ...
                      <div class="two-row" v-if="item3.hasimage_data">
                        <div v-for="(item2,index2) in item3.image_data" :key="index2" class="two-row-item">
                          <div class="item-btns">
                            <el-row>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg2(index,index3,index2)"/>
                              <el-button style="margin-bottom:5px;" icon="el-icon-arrow-up" size="mini" circle @click="upImg2(index,index3,index2)"/>
                      ...
                      <el-button @click="deletaMokuia(index,index3)" type="warning" size="mini" style="position: absolute;right:10px;bottom:8px;z-index:11;">删除模块{{item3.type}}</el-button>
                    </div>
                  </div>
                </div>
                <!-- 自定义商品选择 -->
                <div v-if="item.type==10||item.type==17" class="two-row">
                  <div v-for="(item2,index2) in item.floor_data" :key="index2" class="two-row-item">
                    <div class="item-btns">
                      <el-row>
                        <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg(index,index2)"/>
    ...
    <div class="qunju-bg" v-if="isSetBg">
      <span class="panel-close" @click="closePanel1"><i class="el-icon-close"/></span>
      <div class="edit-panel">
        <div class="bg-hx">
          <div class="col-label" style="margin-right: 10px">
            设置背景色
          </div>
          <div class="block">
        ...
        <div v-if="content.bg_img">
          <el-button type="info" size="mini" plain @click="clearBgImg()">取消背景图</el-button>
        </div>
      </div>
    </div>
    <div class="f-tools">
      <div class="tool-box">
        ...
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(18)">半屏模块</el-button>
        </div>
        <!-- <div class="tool-item">
        ...
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(17)">商品横向</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(11)">优惠券</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(25)">图-优惠券</el-button>
        </div>
        <div class="tool-item">
        ...
        <div class="tool-item">
          <el-button v-if="tplInfo.shop_id==0" type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(15)">砍价专区</el-button>
        </div>
        <div class="tool-item">
          <el-button v-if="tplInfo.shop_id==0" type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(16)">砍价横向</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(19)">通用商品</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(21)">分类列表</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(22,1)">店铺列表1</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(22,2)">店铺列表2</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(22,3)">店铺列表3</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(23)">店铺分组</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(24)">商品分组</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(20)">顶部图片</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="setBgcolor">背景色</el-button>
        </div>
      </div>
      <div class="tool-box">
    ...
    <el-dialog :width="'700px'" :visible.sync="dialogTableVisible5" title="选择店铺">
      <div style="padding:5px 10px;">
        <el-input v-model="key_word2" placeholder="请输入店铺名称" prefix-icon="el-icon-search" size="mini" class="input-with-select">
          <el-button slot="append" icon="el-icon-search" @click="getShops()"/>
        </el-input>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <!-- <el-button
              size="mini"
              type="primary"
              @click="sureSelectShop1(scope.row)">选择</el-button> -->
            <el-button
              v-if="scope.row.select!=1"
              size="mini"
              type="primary"
              @click="AllsureSelect1(scope.row)">选择</el-button>
            <el-button
              v-if="scope.row.select==1"
              size="mini"
              type="success"
              @click="AllsureDelete1(scope.row)">已选择</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-button
          size="mini"
          type="warning"
          @click="sureSelectShop1()"
        >保存</el-button>
      </div>
    </el-dialog>

    <el-dialog :width="'700px'" :visible.sync="dialogTableVisible6" title="选择优惠券">
      <div style="padding:5px 10px;">
        <div>
          <el-select v-model="coupon_type" style="width:200px;" size="mini" placeholder="请选择" >
            <el-option :key="0" :label="'全部'" :value="0"/>
            <el-option :key="1" :label="'通用'" :value="1"/>
            <el-option :key="2" :label="'限指定店铺'" :value="2"/>
            <el-option :key="3" :label="'限指定商品'" :value="3"/>
          </el-select>
          <el-button slot="append" type="primary" icon="el-icon-search" size="mini" @click="getCoupons(1)"/>
        </div>
        <!-- <el-input v-model="key_word3" placeholder="请输入优惠券名称" prefix-icon="el-icon-search" size="mini" class="input-with-select">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button
              ...
              size="mini"
              type="primary"
              @click="AllsureSelect2(scope.row)">选择</el-button>
            <el-button
              v-if="scope.row.select==1"
              size="mini"
              type="success"
              @click="AllsureDelete2(scope.row)">已选择</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div style="display: flex;justify-content: space-between;margin: 10px;">
  ...
  methods: {
    ...
    deletaMokuia(index,index1) {
      ...
      this.$confirm('此操作将删除配置项, 是否继续?', '提示', {
          ...
          self.content.list[index].moduleList.splice(index1, 1)
          this.$message({
            type: 'success',
            message: '删除成功!'
          });
    ...
    // 公告删除所选模块
    deletaMokuia1(index,index1) {
      // console.log(index,index1)
      const self = this
      this.$confirm('操作将删除此优惠券, 是否继续?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
     ...
     // 公告删除所选模块
    deletaMokuia2(index,index1,index2) {
      // console.log(index,index1)
      const self = this
      this.$confirm('操作将删除此优惠券, 是否继续?', '提示', {
          confirmButtonText: '确定',
          ...
          self.content.list[index].floor_data[index1].coupon_list.splice(index2, 1)
          self.content.list[index].floor_data[index1].goods_list.splice(index2, 1)
          this.$message({
            type: 'success',
            message: '删除成功!'
          });
   ...
   setBgcolor() {
    ...
    addTpl(type,type1) {
      ...
      const tpl_obj = {
        ...
        show_type: 0, //轮播图类型： 0：普通。1：层叠。2：圆角。3：方型。导航类型：0：单行导航。1：多行导航
        shadow:0,//0: 无阴影。1：有阴影
        isShow: 1,//0:不显示。1：显示。只是判断公告是否显示。
        isShowAll: 1,//配置的整个模块是否显示。
        borderRadius: 0,//圆角值。
        bgcolor: '',//背景色
        bgurl:'',//背景图
        img_width: 0, // 显示宽度
      ...
      if (type === 1) {
        ...
        tpl_obj.type = '19'
        tpl_obj.title = '通用商品板块标题'
        tpl_obj.moduleList = [ //通用模板列表，最多四个
          {
            title:'',
            content:'',
            floor_data: [],
    ...
    */
    ...
    delImg3(index, index1,index2) {
      const self = this
      self.content.list[index].moduleList[index1].floor_data.splice(index2, 1)

      self.content.list[index].moduleList[index1].goods_list = []
      for (let i = 0; i < self.content.list[index].moduleList[index1].floor_data.length; i++) {
        self.content.list[index].moduleList[index1].goods_list.push(self.content.list[index].moduleList[index1].floor_data[i].id)
      }
      // console.log(self.content.list[index].moduleList[index1])
    },
    ...
    */
    ...
    addImg3(index,index1, t) {
      console.log(index,index1,t)
      
      this.shopIndex = index
      this.shopIndex1 = index1 
      // console.log(this.theIndex1)
    ...
    addImg5(index,index1) {
      console.log(index,index1)
      
      this.yhqIndex = index
      this.yhqIndex1 = index1 //获取优惠券不用包在moduleList里面
      // console.log(this.theIndex1)
      this.dialogTableVisible6 = true
      this.getCoupons()//获取优惠券
        // this.getAllGoods()
    ...
    AllsureDelete1(item) {
      ...
      const self = this
      // 从我创建的目前选中的临时data中删除
      this.shops.forEach(function(v, i, a) {
        if (item.id == v.id) {
          self.$set(self.shops[i], 'select', 0)
        }
      })
      // console.log('已经选中的数据1', this.all_dataList)
      const newArr1 = []
      const newArr2 = []
      this.all_idList.forEach(function(v, i, a) {
        if (v != item.id) {
      ...
      // 从已经被保存好的以前的data中删除  因为不存在连续数据，用splice没事
      // console.log(self.content.list[self.shopIndex].moduleList[self.shopIndex1].floor_data)
     self.content.list[self.shopIndex].moduleList[self.shopIndex1].floor_data.forEach(function(v, i, a) {
        if (v.id == item.id) {
          self.content.list[self.shopIndex].moduleList[self.shopIndex1].floor_data.splice(i, 1)
        }
      })

      self.content.list[self.shopIndex].moduleList[self.shopIndex1].goods_list.forEach(function(v, i, a) {
        if (v == item.id) {
          self.content.list[self.shopIndex].moduleList[self.shopIndex1].goods_list.splice(i, 1)
        }
      })
    ...
    AllsureDelete2(item) {
      ...
      const self = this
      // 从我创建的目前选中的临时data中删除
      this.coupons.forEach(function(v, i, a) {
        if (item.id == v.id) {
          self.$set(self.coupons[i], 'select', 0)
        }
      })
      // console.log('已经选中的数据1', this.all_dataList)
      const newArr1 = []
      ...
      if(self.yhqIndex1===''){
        self.content.list[self.yhqIndex].floor_data.forEach(function(v, i, a) {
          if (v.id == item.id) {
            self.content.list[self.yhqIndex].floor_data.splice(i, 1)
          }
        })

        self.content.list[self.yhqIndex].goods_list.forEach(function(v, i, a) {
          if (v == item.id) {
            self.content.list[self.yhqIndex].goods_list.splice(i, 1)
          }
        })
      }else {
        self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].coupon_list.forEach(function(v, i, a) {
          if (v.id == item.id) {
            self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].coupon_list.splice(i, 1)
          }
        })

        self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].goods_list.forEach(function(v, i, a) {
          if (v == item.id) {
            self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].goods_list.splice(i, 1)
          }
        })
      }
    ...
    markItem() { // 根据all_idList给被选好的数据进行标记  还要根据已经被选好存在的 丧心病狂
     ...
     markItem1() { // 根据all_idList给被选好的数据进行标记  还要根据已经被选好存在的 丧心病狂
      const self = this
      // 根据我选好的

      this.all_idList.forEach(function(val, item, arr) {

        self.shops.forEach(function(v, i, a) {
          if (val == v.id) { // 被展示的该商品是被选中的
            self.$set(self.shops[i], 'select', 1)
          }
        })
      })
     
      self.content.list[self.shopIndex].moduleList[self.shopIndex1].floor_data.forEach(function(val, item, index) {
          self.shops.forEach(function(v, i, a) {
            if (val.id == v.id) { // 被展示的该商品是被选中的
              self.$set(self.shops[i], 'select', 1)
            }
          })
      })
     ...
     markItem2() { // 根据all_idList给被选好的数据进行标记  还要根据已经被选好存在的 丧心病狂
      const self = this
      // 根据我选好的

      this.all_idList.forEach(function(val, item, arr) {

        self.coupons.forEach(function(v, i, a) {
          if (val == v.id) { // 被展示的该商品是被选中的
            self.$set(self.coupons[i], 'select', 1)
          }
        })
      })
    
     if(self.yhqIndex1==="") {
       self.content.list[self.yhqIndex].floor_data.forEach(function(val, item, index) {
          self.coupons.forEach(function(v, i, a) {
            if (val.id == v.id) { // 被展示的该商品是被选中的
              self.$set(self.coupons[i], 'select', 1)
            }
       ...
       self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].coupon_list.forEach(function(val, item, index) {
          self.coupons.forEach(function(v, i, a) {
            if (val.id == v.id) { // 被展示的该商品是被选中的
              self.$set(self.coupons[i], 'select', 1)
            }
    ...
    */
    ...
    saveTplInfo() {
      ...
      for(let i=0;i<list.list.length;i++) {
          ...
          if(list.list[i].floor_data) {
            for(let m=0;m<list.list[i].floor_data.length;m++) {
              if(list.list[i].floor_data[m].good_info) {
                console.log(1,list.list[i].floor_data[m].good_info.select)
                ...
                list.list[i].floor_data[m].good_info = {
                  ...
                  select:list.list[i].floor_data[m].good_info.select
                }
            ...
            for(let m=0;m<list.list[i].moduleList.length;m++) {
              if(list.list[i].moduleList[m].image_data) {
                for(let n=0;n<list.list[i].moduleList[m].image_data.length;n++) {
                  console.log(2,list.list[i].moduleList[m].image_data[n].good_info.select)    
                  list.list[i].moduleList[m].image_data[n].good_info = {
                    ...
                    select:list.list[i].moduleList[m].image_data[n].good_info.select
                  }
                }
              ...
              if(list.list[i].moduleList[m].floor_data) {
                for(let n=0;n<list.list[i].moduleList[m].floor_data.length;n++) {
                  console.log(3,list.list[i].moduleList[m].floor_data[n].good_info.select)
                  list.list[i].moduleList[m].floor_data[n].good_info = {
                    ...
                    select:list.list[i].moduleList[m].floor_data[n].good_info.select
                  }
        ...
        // 排序值
        if(list.list[i].type==23 || list.list[i].type==24) {
          list.list[i].moduleList.sort((a, b) => { return a.sort - b.sort })
        }
    ...
    getClassLeimu() {
      ...
      request({
        ...
        // console.log(res)
        self.data1 = res.data.data.list
      }).catch(function(error) {
        console.log(error)
      })
    },
    // 编辑
    editGroup(index,index1) {
      console.log(index,index1)
      this.content.list[index].moduleList[index1].isEdit = true
    },
    saveGroup(index,index1) {
      // this.editIndex = index
      // this.editIndex1 = index1
      let dataArr = []
      let dataArr1 = []
      // this.editdata = this.content.list[index].moduleList[index1].spLeimuData
      // this.editFldata = this.content.list[index].moduleList[index1].spFenleiData
      for(let i=0;i<this.editdata.length;i++) {
        let data = {}
        data.name = this.editdata[i].name
        data.id = this.editdata[i].id
        dataArr.push(data)
      }
      for(let i=0;i<this.editFldata.length;i++) {
        let data = {}
        data.name = this.editFldata[i].name
        data.mcid = this.editFldata[i].mcid
        dataArr1.push(data)
      }
      // console.log(dataArr,dataArr1)
      if(this.editdata.length>0) {
        this.content.list[index].moduleList[index1].spLeimu = this.editList
        this.content.list[index].moduleList[index1].spLeimuData = dataArr
      }
      if(this.editFldata.length>0) {
        this.content.list[index].moduleList[index1].spFenlei = this.editListFl
        this.content.list[index].moduleList[index1].spFenleiData = dataArr1
      }
      
      console.log(this.content.list[index].moduleList[index1])
      this.content.list[index].moduleList[index1].isEdit = false
    },
    //商品分类回调
    handleNodeClick(data, checked) {
      // console.log(data, checked);
      this.editListFl = checked.checkedKeys
      this.editFldata = checked.checkedNodes
    },
    // 商品类目回调
    handleNodeClick1(data, checked) {
      // let res = this.$refs.tree.getCheckedNodes().concat(this.$refs.tree.getHalfCheckedNodes())
      // console.log(res)
      // console.log(data, checked);
      this.editList = checked.checkedKeys
      this.editdata = checked.checkedNodes
      // this.content.list[this.editIndex].moduleList[this.editIndex1].spLeimu=checked.checkedKeys
    },
    ...
    getCoupons(page) {
      ...
      request({
        method: 'post',
        url: '/coupon/coupon-templet-api/use-coupon',
        data: {
          start_page: self.start_page3,
          pages: 6,
          // key_word: self.key_word3
          item_type: self.coupon_type
        }
      }).then(function(res) {
        // console.log(789,res)
        self.total_pages3 = parseInt(res.data.data.total_pages)
        self.coupons = res.data.data.list
        setTimeout(function() {
          self.markItem2()
        }, 150)
        // console.log(111,self.shops)
    ...
    sureSelectShop1(item) {
      ...
      self.all_dataList.forEach(function(val, ind, arr) {
        arr1[ind].id = val.id
        arr1[ind].name = val.name
        arr1[ind].select = val.select
      })
      console.log(arr1)
      arr1.forEach(function(v, i, a) {
        self.content.list[self.shopIndex].moduleList[self.shopIndex1].floor_data.push(v)
      })
      for (let i = 0; i < arr1.length; i++) {
        self.content.list[self.shopIndex].moduleList[self.shopIndex1].goods_list.push(arr1[i].id)
      }
      
      // let data = {}
      // data.name = item.name
      // data.id = item.id
      // self.content.list[this.shopIndex].moduleList[this.shopIndex1].floor_data.push(data)
      // self.content.list[this.shopIndex].moduleList[this.shopIndex1].goods_list.push(item.id)
      // console.log('需要的数据',self.content.list[this.shopIndex].moduleList[this.shopIndex1])
      
      self.start_page2 = 0
      self.total_pages2 = null
      self.key_word2 = ''
      self.shops = []
      self.all_dataList = []
      self.all_idList = []
    ...
    sureSelectShop2(item) {
      ...
      if(self.yhqIndex1==='') {
        arr1.forEach(function(v, i, a) {
          self.content.list[self.yhqIndex].floor_data.push(v)
        })
        for (let i = 0; i < arr1.length; i++) {
          self.content.list[self.yhqIndex].goods_list.push(arr1[i].id)
        }
      }else{
        arr1.forEach(function(v, i, a) {
          if(self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].coupon_list.length<3) {
            self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].coupon_list.push(v)
          }
          console.log(self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].coupon_list)
        })
        for (let i = 0; i < arr1.length; i++) {
          if(self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].goods_list.length<3) {
            self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].goods_list.push(arr1[i].id)
          }
          console.log(self.content.list[self.yhqIndex].floor_data[self.yhqIndex1].goods_list)
        }
      }
          ...
          .tpl-item-box1{
            ...
            .item-box-item{
              ...
              .no-img{
                ...
                &.shop1 {
                  height: 240px;
                  background-image:url('../../assets/screenshot/shop1.jpg');
                }
                &.shop2 {
                  height: 260px;
                  background-image:url('../../assets/screenshot/shop2.png');
                }
                &.shop3 {
                  height: 135px;
                  background-image:url('../../assets/screenshot/shop3.jpg');
                }
                &.shop_group {
                  height: 40px;
                  background-image:url('../../assets/screenshot/shop_group.png');
                }
                &.sp_group {
                  height: 40px;
                  background-image:url('../../assets/screenshot/sp_group.png');
                }
                &.ty_sp {
                  height: 300px;
                  background-image:url('../../assets/screenshot/ty_sp.jpg');
                }
              }
              .item-box-item__mask{
                position: absolute;
