<template>
  <div class="app-container">
    ...
    <el-table :data="patternList" fit highlight-current-row style="width: 200%;">
      ...
      <el-table-column label="支付宝号" align="center" min-width="150px" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <span>{{row.endTime}}</span>
        </template>
      </el-table-column>
    ...
    <!-- 添加模式对话框-->
    <el-dialog title="添加持卡人" :visible.sync="addPatternlogVisible" min-width="500px">
